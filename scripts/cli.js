...
const contractABI = require("../artifacts/contracts/Zcashshield.sol/Zcashshield.json").abi;

program
    .name("zcashshield-cli")
    .description("CLI tool for Zcashshield smart contract")
    .version("1.0.0");
